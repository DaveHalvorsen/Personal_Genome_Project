...
```{r}
# height_CSV$Participant
# height_CSV$Height
height_DF <- data.frame("Participant" = height_CSV$Participant, "Height" = height_CSV$Height)
height_DF
gender_DF <- unique(height_DF)

# gender_CSV$Participant
# gender_CSV$Gender
#gender_DF <- data.frame(Participant = gender_CSV$Participant, Gender = gender_CSV$Gender)
#gender_DF
gender_DF <- unique(gender_data_frame)
gender_DF
```

```{r}
#height_data_frame
height_and_gender <- merge(gender_DF, height_data_frame, by="Participant")
height_and_gender
```
